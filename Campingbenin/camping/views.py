    ...
    if request.method == 'POST':
        ...
        if size and total_amount and installments:
            ...
            if installments > 1:
                ...
                # Effectuer ici les étapes nécessaires pour rediriger vers l'API de KKIApy
                # avec l'information sur le montant de chaque tranche
                ...
                # Effectuer ici les étapes nécessaires pour rediriger vers l'API de KKIApy
                # sans division du montant total
                # Effectuez ici d'autres actions en fonction du statut de paiement
        else:
